...
K8S_PV_NFS_SERVER=
K8S_PV_NFS_PATH= # 配置 NFS 存储仓库的目录，需要事先在 NFS 服务器创建好该目录以及其子目录，redis 节点存储的完整路径为 <K8S_PV_NFS_PATH>/redis-cluster-data-<REDIS_PORT_NUMBER>，例如: K8S_PV_NFS_PATH 设置为 /mnt/nfs/redis-cluster-storages，那么需要事先创建好 /mnt/nfs/redis-cluster-storages/redis-cluster-data-<REDIS_PORT_NUMBER>
